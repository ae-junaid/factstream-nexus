...
export const mockWarMedia: WarMedia[] = [
  ...
  },
  {
    ...
    caption: 'Reports of smoke rising over southern Beirut suburbs after overnight strikes',
    source: '@LBCINews',
    platform: 'X',
  ...
  },
  {
    ...
    caption: 'Displaced families sheltering at UNRWA school in Deir al-Balah',
    source: '@WHO',
    platform: 'X',
    credibility: 'verified',
